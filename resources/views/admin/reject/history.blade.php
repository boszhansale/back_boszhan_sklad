...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                @foreach($reject->baskets()->withTrashed()->get() as $basket)
                    <tr>
    ...
    @if(Auth::id() == 1)
        <div class="card">
            ...
            <div class="card-header">Заявка №{{$reject->id}} от {{$reject->created_at}}</div>
            <div class="card-body">
                <table class="table table-bordered">
                    <thead>
                    <tr>
                    ...
                    <tbody>
                    @foreach($reject->audits()->where('event','<>','created')->get() as $audit)
                        <tr>
